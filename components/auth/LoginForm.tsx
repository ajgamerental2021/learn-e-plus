  ...
  return (
    <Card>
      <CardHeader>
        ...
        <CardDescription>กรอกอีเมล / Username และรหัสผ่านเพื่อเข้าสู่ระบบ</CardDescription>
      </CardHeader>
      <CardContent>
        ...
        <form onSubmit={handleSubmit} className="space-y-4">
          <div className="space-y-2">
            <Label htmlFor="email">อีเมล หรือ Username</Label>
            <Input
              id="email"
              type="text"
              placeholder="you@example.com หรือ somchai99"
              value={email}
